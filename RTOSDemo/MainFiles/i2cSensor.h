...
#define vtSensorMaxLen   (sizeof(portTickType))
...
portBASE_TYPE SendTempSensorMsg(vtSensorStruct *sensorData,portTickType ticksElapsed,portTickType ticksToBlock);
//
...
// Return:
//   Result of the call to xQueueSend()
portBASE_TYPE SendSensorValueMsg(vtSensorStruct *tempData,uint8_t msgType,uint8_t value,portTickType ticksToBlock);
#endif