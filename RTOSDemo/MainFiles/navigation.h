...
typedef struct vtNavStruct {
	...
	struct vtMotorStruct *motorData;
	xQueueHandle inQ;
} vtNavStruct;
...
void vStartNavTask(vtNavStruct *navData, unsigned portBASE_TYPE uxPriority, vtLCDStruct *lcd, struct vtInfraredStruct *sensor, struct vtMotorStruct *motor);
